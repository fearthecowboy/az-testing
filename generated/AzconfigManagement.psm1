# region Initialization
    ...
    $instance =  [Microsoft.Azure.AzConfig.Module]::Instance

    # load nested script module if it exists
    if(Test-Path "$PSScriptRoot/bin/AzconfigManagement.scripts.psm1") {
      Import-Module "$PSScriptRoot/bin/AzconfigManagement.scripts.psm1"
    }

    $privatemodule = Import-Module -PassThru "$PSScriptRoot/bin/AzconfigManagement.private.dll"
