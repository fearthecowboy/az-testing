namespace Microsoft.Azure.AzConfig.Models
{
    ...
    /// </summary>
    public class OperationDefinitionListResultTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                OperationDefinitionListResult.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new OperationDefinitionListResult
                {
