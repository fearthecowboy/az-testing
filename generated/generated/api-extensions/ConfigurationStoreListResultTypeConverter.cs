namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models
{
    ...
    /// </summary>
    public class ConfigurationStoreListResultTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ConfigurationStoreListResult.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new ConfigurationStoreListResult
                {
