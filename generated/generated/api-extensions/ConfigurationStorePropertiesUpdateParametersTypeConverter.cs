namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models
{
    ...
    /// />
    /// </summary>
    public class ConfigurationStorePropertiesUpdateParametersTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                ConfigurationStorePropertiesUpdateParameters.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
