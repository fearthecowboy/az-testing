namespace Microsoft.Azure.AzConfig.Models
{
    ...
    /// </summary>
    public class OperationDefinitionDisplayTypeConverter : System.Management.Automation.PSTypeConverter
    {
        ...
        public static object ConvertFrom(dynamic sourceValue)
        {
            ...
            try
            {
                OperationDefinitionDisplay.FromJsonString(typeof(string) == sourceValue.GetType() ? sourceValue : sourceValue.ToJsonString());
            }
            catch
            {
                // Unable to use JSON pattern
            ...
            try
            {
                return new OperationDefinitionDisplay
                {
