namespace Microsoft.Azure.AzConfig.Models
{
    ...
    public partial class ApiKeyListResult
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.AzConfig.Runtime.Json.JsonObject into a new instance of <see cref="ApiKeyListResult" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.AzConfig.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ApiKeyListResult(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json)
        {
            ...
            _value = If( json?.PropertyT<Microsoft.Azure.AzConfig.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue, out var __v) ? new System.Func<Microsoft.Azure.AzConfig.Models.IApiKey[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __v, (__u)=>(Microsoft.Azure.AzConfig.Models.IApiKey) (Microsoft.Azure.AzConfig.Models.ApiKey.FromJson(__u) ) ) ) )() : null : Value;
            AfterFromJson(json);
        }
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.AzConfig.Models.IApiKeyListResult.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.AzConfig.Models.IApiKeyListResult.</returns>
        public static Microsoft.Azure.AzConfig.Models.IApiKeyListResult FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json ? new ApiKeyListResult(json) : null;
        }
        /// <summary>
        /// Serializes this instance of <see cref="ApiKeyListResult" /> into a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ApiKeyListResult" /> as a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" />.
        /// </returns>
