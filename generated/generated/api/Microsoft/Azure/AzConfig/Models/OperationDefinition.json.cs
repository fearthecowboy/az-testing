namespace Microsoft.Azure.AzConfig.Models
{
    ...
    public partial class OperationDefinition
    {
        ...
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.AzConfig.Models.IOperationDefinition.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.AzConfig.Models.IOperationDefinition.</returns>
        public static Microsoft.Azure.AzConfig.Models.IOperationDefinition FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json ? new OperationDefinition(json) : null;
        }
        /// <summary>
        ...
        /// <summary>
        /// Serializes this instance of <see cref="OperationDefinition" /> into a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="OperationDefinition" /> as a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" />.
        /// </returns>
        public Microsoft.Azure.AzConfig.Runtime.Json.JsonNode ToJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject container, Microsoft.Azure.AzConfig.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != Display ? (Microsoft.Azure.AzConfig.Runtime.Json.JsonNode) Display.ToJson(null) : null, "display" ,container.Add );
