namespace Microsoft.Azure.AzConfig.Models
{
    ...
    public partial class ConfigurationStoreListResult
    {
        ...
        /// <summary>
        /// Deserializes a Microsoft.Azure.AzConfig.Runtime.Json.JsonObject into a new instance of <see cref="ConfigurationStoreListResult" />.
        /// </summary>
        /// <param name="json">A Microsoft.Azure.AzConfig.Runtime.Json.JsonObject instance to deserialize from.</param>
        internal ConfigurationStoreListResult(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json)
        {
            ...
            _value = If( json?.PropertyT<Microsoft.Azure.AzConfig.Runtime.Json.JsonArray>("value"), out var __jsonValue) ? If( __jsonValue, out var __v) ? new System.Func<Microsoft.Azure.AzConfig.Models.IConfigurationStore[]>(()=> System.Linq.Enumerable.ToArray(System.Linq.Enumerable.Select( __v, (__u)=>(Microsoft.Azure.AzConfig.Models.IConfigurationStore) (Microsoft.Azure.AzConfig.Models.ConfigurationStore.FromJson(__u) ) ) ) )() : null : Value;
            AfterFromJson(json);
        }
        /// <summary>
        /// Deserializes a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode"/> into an instance of Microsoft.Azure.AzConfig.Models.IConfigurationStoreListResult.
        /// </summary>
        /// <param name="node">a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" /> to deserialize from.</param>
        /// <returns>an instance of Microsoft.Azure.AzConfig.Models.IConfigurationStoreListResult.</returns>
        public static Microsoft.Azure.AzConfig.Models.IConfigurationStoreListResult FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json ? new ConfigurationStoreListResult(json) : null;
        }
        /// <summary>
        /// Serializes this instance of <see cref="ConfigurationStoreListResult" /> into a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" />.
        /// </summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="ConfigurationStoreListResult" /> as a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" />.
        /// </returns>
