namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models
{
    ...
    public partial class ConfigurationStoreListResult : Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStoreListResult, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IValidates
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStore[] _value;

        /// <summary>The collection value.</summary>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStore[] Value
        {
            get
            {
                return this._value;
    ...
    public partial interface IConfigurationStoreListResult : Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IJsonSerializable {
        string NextLink { get; set; }
        Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStore[] Value { get; set; }
    }
}