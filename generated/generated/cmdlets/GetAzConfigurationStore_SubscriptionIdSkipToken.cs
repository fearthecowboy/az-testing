namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzConfigurationStore_SubscriptionIdSkipToken")]
    ...
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Description(@"Lists the configuration stores for a given subscription.")]
    [Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Generated]
    public class GetAzConfigurationStore_SubscriptionIdSkipToken : System.Management.Automation.PSCmdlet, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzConfigurationStore_SubscriptionIdSkipToken</returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.GetAzConfigurationStore_SubscriptionIdSkipToken Clone()
        {
        ...
        /// <returns>an instance of GetAzConfigurationStore_SubscriptionIdSkipToken.</returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.GetAzConfigurationStore_SubscriptionIdSkipToken FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json ? new GetAzConfigurationStore_SubscriptionIdSkipToken(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="GetAzConfigurationStore_SubscriptionIdSkipToken" /> cmdlet
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.GetAzConfigurationStore_SubscriptionIdSkipToken FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzConfigurationStore_SubscriptionIdSkipToken" /> cmdlet class.
        /// </summary>
        public GetAzConfigurationStore_SubscriptionIdSkipToken()
        {
        }
        ...
        internal GetAzConfigurationStore_SubscriptionIdSkipToken(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ConfigurationStoresList(SubscriptionId, SkipToken, onOK, onDefault, this, Pipeline);
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}\nBody: {await responseMessage.Content.ReadAsStringAsync()}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId,SkipToken}));
                }
                else
                {
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"[{code}] : {message}"), code?.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId,SkipToken}));
                }
            }
        }
