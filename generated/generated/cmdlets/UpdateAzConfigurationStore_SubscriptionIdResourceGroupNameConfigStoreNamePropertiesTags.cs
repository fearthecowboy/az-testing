namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsData.Update, @"AzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags", HelpUri = "Updates a configuration store with the specified parameters.", SupportsShouldProcess = true)]
    ...
    public class UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags : System.Management.Automation.PSCmdlet, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        /// <summary>Backing field for <see cref="ConfigStoreUpdateParameters" /> property.</summary>
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStoreUpdateParameters _configStoreUpdateParameters;

        /// <summary>The parameters for updating a configuration store.</summary>
        [System.Management.Automation.Parameter(Mandatory = true, HelpMessage = "The parameters for updating a configuration store.", ValueFromPipeline = true)]
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IConfigurationStoreUpdateParameters ConfigStoreUpdateParameters
        {
            get
            {
                return this._configStoreUpdateParameters;
            }
            set
            {
                this._configStoreUpdateParameters = value;
            }
        }
        /// <summary>
        ...
        /// <returns>
        /// a duplicate instance of UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags Clone()
        {
        ...
        /// <returns>
        /// an instance of UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json ? new UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags"
        /// /> cmdlet
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ConfigurationStoresUpdate(SubscriptionId, ResourceGroupName, ConfigStoreName, ConfigStoreUpdateParameters, onOK, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags"
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != ConfigStoreUpdateParameters ? (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode) ConfigStoreUpdateParameters.ToJson(null) : null, "ConfigStoreUpdateParameters" ,container.Add );
            return container;
        }
        ...
        internal UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            _configStoreUpdateParameters = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("ConfigStoreUpdateParameters"), out var __jsonConfigStoreUpdateParameters) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.ConfigurationStoreUpdateParameters.FromJson(__jsonConfigStoreUpdateParameters) : ConfigStoreUpdateParameters;
        }
        /// <summary>
        /// Intializes a new instance of the <see cref="UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags"
        /// /> cmdlet class.
        /// </summary>
        public UpdateAzConfigurationStore_SubscriptionIdResourceGroupNameConfigStoreNamePropertiesTags()
        {
        }
        /// <summary>
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}\nBody: {await responseMessage.Content.ReadAsStringAsync()}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId,ResourceGroupName,ConfigStoreName,ConfigStoreUpdateParameters}));
                }
                else
                {
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"[{code}] : {message}"), code?.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId,ResourceGroupName,ConfigStoreName,ConfigStoreUpdateParameters}));
                }
            }
        }
