namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzConfigurationStore_SubscriptionId", HelpUri = "Lists the configuration stores for a given subscription.")]
    ...
    public class GetAzConfigurationStore_SubscriptionId : System.Management.Automation.PSCmdlet, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.GetAzConfigurationStore_SubscriptionId Clone()
        {
        ...
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.GetAzConfigurationStore_SubscriptionId FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json ? new GetAzConfigurationStore_SubscriptionId(json) : null;
        }
        /// <summary>
        ...
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.GetAzConfigurationStore_SubscriptionId FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        ...
        internal GetAzConfigurationStore_SubscriptionId(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzConfigurationStore_SubscriptionId" /> as a <see cref="Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode" />.
        /// </returns>
