namespace Microsoft.Azure.AzConfig.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzOperation_Etc")]
    [System.Management.Automation.OutputType(typeof(Microsoft.Azure.AzConfig.Models.IOperationDefinitionListResult))]
    public class GetAzOperation_Etc : System.Management.Automation.PSCmdlet, Microsoft.Azure.AzConfig.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzOperation_Etc</returns>
        public Microsoft.Azure.AzConfig.Cmdlets.GetAzOperation_Etc Clone()
        {
        ...
        /// <returns>an instance of GetAzOperation_Etc.</returns>
        public static Microsoft.Azure.AzConfig.Cmdlets.GetAzOperation_Etc FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json ? new GetAzOperation_Etc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="GetAzOperation_Etc" /> cmdlet</returns>
        public static Microsoft.Azure.AzConfig.Cmdlets.GetAzOperation_Etc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzOperation_Etc" /> cmdlet class.
        /// </summary>
        public GetAzOperation_Etc()
        {
        }
        ...
        internal GetAzOperation_Etc(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OperationsList(null, onOK, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzOperation_Etc" /> as a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Microsoft.Azure.AzConfig.Models.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                {
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"[{code}] : {message}"), code?.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { }));
                }
            }
        }
