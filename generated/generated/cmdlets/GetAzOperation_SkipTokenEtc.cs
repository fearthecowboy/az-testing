namespace Microsoft.Azure.AzConfig.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet Get-Operation.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.Get, @"AzOperation_SkipTokenEtc")]
    [System.Management.Automation.OutputType(typeof(Microsoft.Azure.AzConfig.Models.IOperationDefinitionListResult))]
    public class GetAzOperation_SkipTokenEtc : System.Management.Automation.PSCmdlet, Microsoft.Azure.AzConfig.Runtime.IEventListener
    {
        ...
        /// <returns>a duplicate instance of GetAzOperation_SkipTokenEtc</returns>
        public Microsoft.Azure.AzConfig.Cmdlets.GetAzOperation_SkipTokenEtc Clone()
        {
        ...
        /// <returns>an instance of GetAzOperation_SkipTokenEtc.</returns>
        public static Microsoft.Azure.AzConfig.Cmdlets.GetAzOperation_SkipTokenEtc FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json ? new GetAzOperation_SkipTokenEtc(json) : null;
        }
        /// <summary>
        ...
        /// <returns>returns a new instance of the <see cref="GetAzOperation_SkipTokenEtc" /> cmdlet</returns>
        public static Microsoft.Azure.AzConfig.Cmdlets.GetAzOperation_SkipTokenEtc FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject.Parse(jsonText));
        /// <summary>
        /// Intializes a new instance of the <see cref="GetAzOperation_SkipTokenEtc" /> cmdlet class.
        /// </summary>
        public GetAzOperation_SkipTokenEtc()
        {
        }
        ...
        internal GetAzOperation_SkipTokenEtc(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json)
        {
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.OperationsList(SkipToken, onOK, onDefault, this, Pipeline);
        ...
        /// <returns>
        /// a serialized instance of <see cref="GetAzOperation_SkipTokenEtc" /> as a <see cref="Microsoft.Azure.AzConfig.Runtime.Json.JsonNode" />.
        /// </returns>
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Microsoft.Azure.AzConfig.Models.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}\nBody: {await responseMessage.Content.ReadAsStringAsync()}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { SkipToken}));
                }
                else
                {
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"[{code}] : {message}"), code?.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { SkipToken}));
                }
            }
        }
        /// <summary>a delegate that is called when the remote service returns 200 (OK).</summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.AzConfig.Models.IOperationDefinitionListResult"
        /// /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Microsoft.Azure.AzConfig.Models.IOperationDefinitionListResult> response)
        {
            using( NoSynchronizationContext )
            {
