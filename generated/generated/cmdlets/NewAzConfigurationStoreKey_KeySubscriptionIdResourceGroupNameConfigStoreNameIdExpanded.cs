namespace Microsoft.Azure.AzConfig.Cmdlets
{
    ...
    /// <summary>Implement a variant of the cmdlet New-ConfigurationStoreKey.</summary>
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Microsoft.Azure.AzConfig.Models.IApiKey))]
    public class NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded : System.Management.Automation.PSCmdlet, Microsoft.Azure.AzConfig.Runtime.IEventListener
    {
        ...
        public string Id
        {
            set
            {
                RegenerateKeyParametersBody.Id = value;
            }
        }
        ...
        private Microsoft.Azure.AzConfig.Models.IRegenerateKeyParameters _regenerateKeyParametersBody= new Microsoft.Azure.AzConfig.Models.RegenerateKeyParameters();

        /// <summary>The parameters used to regenerate an API key.</summary>
        private Microsoft.Azure.AzConfig.Models.IRegenerateKeyParameters RegenerateKeyParametersBody
        {
            get
            {
                return this._regenerateKeyParametersBody;
            }
            set
            {
                this._regenerateKeyParametersBody = value;
            }
        }
        ...
        /// <returns>
        /// a duplicate instance of NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded
        /// </returns>
        public Microsoft.Azure.AzConfig.Cmdlets.NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded Clone()
        {
        ...
        /// <returns>
        /// an instance of NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded.
        /// </returns>
        public static Microsoft.Azure.AzConfig.Cmdlets.NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json ? new NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded"
        /// /> cmdlet
        /// </returns>
        public static Microsoft.Azure.AzConfig.Cmdlets.NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        /// <summary>
        /// Intializes a new instance of the <see cref="NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded"
        /// /> cmdlet class.
        /// </summary>
        public NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded()
        {
        }
        ...
        internal NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject json)
        {
            ...
            _regenerateKeyParametersBody = If( json?.PropertyT<Microsoft.Azure.AzConfig.Runtime.Json.JsonObject>("RegenerateKeyParametersBody"), out var __jsonRegenerateKeyParametersBody) ? Microsoft.Azure.AzConfig.Models.RegenerateKeyParameters.FromJson(__jsonRegenerateKeyParametersBody) : RegenerateKeyParametersBody;
        }
        ...
        /// <returns>
        /// a serialized instance of <see cref="NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded"
        ...
        public Microsoft.Azure.AzConfig.Runtime.Json.JsonNode ToJson(Microsoft.Azure.AzConfig.Runtime.Json.JsonObject container, Microsoft.Azure.AzConfig.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != RegenerateKeyParametersBody ? (Microsoft.Azure.AzConfig.Runtime.Json.JsonNode) RegenerateKeyParametersBody.ToJson(null) : null, "RegenerateKeyParametersBody" ,container.Add );
            return container;
        }
        /// <summary>
        ...
        private async System.Threading.Tasks.Task onDefault(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Microsoft.Azure.AzConfig.Models.IError> response)
        {
            using( NoSynchronizationContext )
            {
                ...
                if ((null == code || null == message))
                {
                    ...
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"The service encountered an unexpected result: {responseMessage.StatusCode}\nBody: {await responseMessage.Content.ReadAsStringAsync()}"), responseMessage.StatusCode.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId,ResourceGroupName,ConfigStoreName,RegenerateKeyParametersBody}));
                }
                else
                {
                    WriteError(new System.Management.Automation.ErrorRecord(new System.Exception($"[{code}] : {message}"), code?.ToString(), System.Management.Automation.ErrorCategory.InvalidOperation, new { SubscriptionId,ResourceGroupName,ConfigStoreName,RegenerateKeyParametersBody}));
                }
            }
        }
        /// <summary>a delegate that is called when the remote service returns 200 (OK).</summary>
        /// <param name="responseMessage">the raw response message as an System.Net.Http.HttpResponseMessage.</param>
        /// <param name="response">the body result as a <see cref="Microsoft.Azure.AzConfig.Models.IApiKey" /> from the remote call</param>
        /// <returns>
        /// A <see cref="System.Threading.Tasks.Task" /> that will be complete when handling of the method is completed.
        /// </returns>
        private async System.Threading.Tasks.Task onOK(System.Net.Http.HttpResponseMessage responseMessage, System.Threading.Tasks.Task<Microsoft.Azure.AzConfig.Models.IApiKey> response)
        {
            using( NoSynchronizationContext )
            {
                // onOK - response for 200 / application/json
                // (await response) // should be Microsoft.Azure.AzConfig.Models.IApiKey
