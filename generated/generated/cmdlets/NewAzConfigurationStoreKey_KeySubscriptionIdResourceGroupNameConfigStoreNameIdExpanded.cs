namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsCommon.New, @"AzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded", HelpUri = "Regenerates an access key for the specified configuration store.", SupportsShouldProcess = true)]
    [System.Management.Automation.OutputType(typeof(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IApiKey))]
    public class NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded : System.Management.Automation.PSCmdlet, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.IRegenerateKeyParameters RegenerateKeyParametersBody
        {
            get
            {
        ...
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded Clone()
        {
        ...
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json ? new NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded(json) : null;
        }
        /// <summary>
        ...
        /// /> cmdlet
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        internal NewAzConfigurationStoreKey_KeySubscriptionIdResourceGroupNameConfigStoreNameIdExpanded(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            _regenerateKeyParametersBody = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("RegenerateKeyParametersBody"), out var __jsonRegenerateKeyParametersBody) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.RegenerateKeyParameters.FromJson(__jsonRegenerateKeyParametersBody) : RegenerateKeyParametersBody;
        }
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != RegenerateKeyParametersBody ? (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode) RegenerateKeyParametersBody.ToJson(null) : null, "RegenerateKeyParametersBody" ,container.Add );
            return container;
        }
        /// <summary>
