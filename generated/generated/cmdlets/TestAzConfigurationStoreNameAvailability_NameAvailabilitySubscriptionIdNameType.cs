namespace Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets
{
    ...
    [System.Management.Automation.Cmdlet(System.Management.Automation.VerbsDiagnostic.Test, @"AzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType", HelpUri = "Checks whether the configuration store name is available for use.", SupportsShouldProcess = true)]
    ...
    public class TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType : System.Management.Automation.PSCmdlet, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.IEventListener
    {
        ...
        private Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.ICheckNameAvailabilityParameters _checkNameAvailabilityParameters;
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.ICheckNameAvailabilityParameters CheckNameAvailabilityParameters
        {
            get
            {
        ...
        /// <returns>
        /// a duplicate instance of TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType
        /// </returns>
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType Clone()
        {
        ...
        /// <returns>
        /// an instance of TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType.
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode node)
        {
            return node is Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json ? new TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType(json) : null;
        }
        /// <summary>
        ...
        /// <returns>
        /// returns a new instance of the <see cref="TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType"
        /// /> cmdlet
        /// </returns>
        public static Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Cmdlets.TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType FromJsonString(string jsonText) => string.IsNullOrEmpty(jsonText) ? null : FromJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject.Parse(jsonText));
        ...
        protected async System.Threading.Tasks.Task ProcessRecordAsync()
        {
            using( NoSynchronizationContext )
            {
                ...
                try
                {
                    ...
                    await this.Client.ConfigurationStoresCheckNameAvailability(SubscriptionId, CheckNameAvailabilityParameters, onOK, onDefault, this, Pipeline);
        ...
        internal TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject json)
        {
            ...
            _checkNameAvailabilityParameters = If( json?.PropertyT<Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject>("CheckNameAvailabilityParameters"), out var __jsonCheckNameAvailabilityParameters) ? Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Models.CheckNameAvailabilityParameters.FromJson(__jsonCheckNameAvailabilityParameters) : CheckNameAvailabilityParameters;
        }
        /// <summary>
        /// Intializes a new instance of the <see cref="TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType"
        /// /> cmdlet class.
        /// </summary>
        public TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType()
        {
        }
        /// <summary>
        ...
        /// <returns>
        /// a serialized instance of <see cref="TestAzConfigurationStoreNameAvailability_NameAvailabilitySubscriptionIdNameType" />
        ...
        public Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode ToJson(Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonObject container, Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.SerializationMode serializationMode)
        {
            ...
            AddIf( null != CheckNameAvailabilityParameters ? (Microsoft.Azure.PowerShell.Cmdlets.AppConfiguration.Runtime.Json.JsonNode) CheckNameAvailabilityParameters.ToJson(null) : null, "CheckNameAvailabilityParameters" ,container.Add );
            return container;
        }
        /// <summary>
